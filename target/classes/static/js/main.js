function getBasePath() {
    ...
    var host = url.host;//'localhost:8081'
    var pathname = url.pathname;//'/deskspaceserver/index'
    var context = pathname.substring(0, pathname.lastIndexOf("/"));//'/deskspaceserver'
    return host + context;
}
...
$(function () {
    console.log("++++++++++in main js:" + base_url);
    var basePath = getBasePath();
    var ws = new WebSocket("ws://" + basePath + "/ws?source=browser");
    ...
    ws.onmessage = function (evt) {
        ...
        $('#result').append('<div>' + data.data + '</div>');
        // ws.close();
    };
